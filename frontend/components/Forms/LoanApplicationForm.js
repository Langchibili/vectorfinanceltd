...
export default class PostForm extends React.Component{
   constructor(props){
      ...
      this.state = {
         ...
         userSelectedLoanType: this.props.action === "create"? false : true,
  ...
  async componentDidMount(){
   ...
   renderPostForm = ()=>{
    ...
    //  }
     return this.state.userSelectedLoanType? this.renderForm() : this.loanTypeSelector()
   }
