...
export default class UpdateLandCollateralForm extends React.Component {
  ...
  handleSubmit = async (e)=>{
    ...
    const updateObject = {
     ...
     if(!updateObject.data.collateral.land.plotNumber){
         updateObject.data.collateral.land.plotNumber = null
     }
     if(!updateObject.data.collateral.land.hectors){
         updateObject.data.collateral.land.hectors = null
     }
     if(!updateObject.data.collateral.land.location){
         updateObject.data.collateral.land.location = null
     }
  ...
  handleFinishLoanApplication = async ()=>{
    ...
    if(!updatedLoan.hasOwnProperty('error')){
        ...
        const notificationObject = {
            title: "A new asset loan of land collateral, with id "+updatedLoan.id+ ", and amount K"+updatedLoan.loanAmount+" has been initiated on VectorFin",
            type: "alert"
        }
