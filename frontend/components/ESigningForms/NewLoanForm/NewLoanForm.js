...
// //               </p>
// //               <div>
// //               <p>(Vector Finance Limited will not be liable for any payments made to incorrect beneficiary based on banking
// // information provided by the Borrower as above. Any payments made as such will be taken as payments made to 
// // the Borrower and will be treated as intended in this agreement.)</p>
// // <p style={{marginTop:'40px'}}>We refer to your application above and are pleased to offer you a loan facility as outlined below:
// // </p>
// //               </div>
  
// //               <p>
// //               <b style={{fontSize:'16.5px'}}>Facility Type:</b>
// //                 <input type="text" style={inputStyle} />
// //               </p>
// //               <p>
// //               <b style={{fontSize:'16.5px'}}>Loan Amount::</b>
// //                 <input type="text" style={inputStyle} />
// //               </p>
// //               <b>Purpose of Loan:</b>
...
// //               Download as PDF
// //             </button> */}
// //             <button  className="btn btn-danger" onClick={this.saveHandwritingToAPI} style={{ marginTop: '20px' }}>
...
//             <p>
//               <b>Date:</b>{" "}
//               <input type="text" style={inputStyle} /> (the “Commencement Date”)
//             </p>
//             <p>
//               <b>Name:</b>{" "}
//               <input type="text" style={inputStyle} /> (the “Customer” or the “Borrower”)
//             </p>
//             <p>
//               <b>Title:</b>{" "}
//               <input type="text" style={inputStyle} />
...
//               Witness
//               <br />
//               Name: <input type="text" style={inputStyle} /><br />
//               Address: <input type="text" style={inputStyle} /><br />
//               Occupation: <input type="text" style={inputStyle} /><br />
//               Signature:
//             </p>
//             <p>
//               SIGNED by )<br />
