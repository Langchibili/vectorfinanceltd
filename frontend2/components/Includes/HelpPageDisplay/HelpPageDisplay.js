  ...
  return (
    <>
      <div style={{ width: '100%', margin: '0 auto', textAlign: 'center' }}>
        <div>
          <a
            href='https://vectorfinancelimited.com/contact-us/'
            target='_blank'
            ...
            style={{
              ...
              padding: 5,
              border: `1px solid ${isDark ? '#60A5FA' : '#1976d2'}`,
              borderRadius: 4,
              color: isDark ? '#60A5FA' : '#1976d2',
              textDecoration: 'none',
            }}
          >
            <Info color='info' /> See Our Contact Details
          </a>
        </div>
      </div>
      <br />
      <CopyAndWhatsAppButtons
        buttonText="Text Us On WhatsApp"
        info={
          <>
            To get help or ask anything about our app, please send a whatsapp message to this number:{' '}
            <strong><span id="copyNumber">+260979460045</span></strong>
          </>
        }
      />
      <div
